...
import 'package:quickauth_flutter/dashboard.dart';
import 'package:quickauth_flutter/signup.dart';
...
class _SigninState extends State<Signin> {
  ...
  Future save() async{
    var res = await http.post(
      Uri.parse("https://p066xjm1-8000.inc1.devtunnels.ms/api/auth/login"),
    ...
    if (res.statusCode == 200) {
      ...
      // print("Raew Cookie: $rawCookie");
      // rawCookie is e.g. "token=XXX; Path=/; Expires=…"
      final token = rawCookie.split(';').first.split('token=').last;
      // print("Token: $token");
          ...
          Container(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 200,),
                  Text("Signin", style: GoogleFonts.pacifico(
